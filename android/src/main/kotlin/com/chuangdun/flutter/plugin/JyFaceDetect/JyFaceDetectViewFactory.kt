...
class JyFaceDetectViewFactory(context: Context, private val aliveDetect: AliveDetect, private val messenger: BinaryMessenger)
    :PlatformViewFactory(StandardMessageCodec.INSTANCE){

    override fun create(context: Context, viewId: Int, createParams: Any): PlatformView {
        return JyFaceDetectView(context,
